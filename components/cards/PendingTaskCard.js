...
const PendingTaskCard = () => {
    return (
            <View
                className="rounded-lg border  border-[#d9d9e1] shadow-sm bg-white ml-2  mr-2 mt-5 mx-4  "
            ...
            >
                ...
                <View className="p-2">
                    <TouchableOpacity className="w-full bg-emerald-700 p-3 rounded-md text-center">
